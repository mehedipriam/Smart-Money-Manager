...
/**
 * A single-use "forgot password" token. A user may accumulate several rows
 * over time (one per reset request); only the most recent, unused,
 * unexpired one is valid.
 */
@Entity
